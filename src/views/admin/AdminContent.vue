      ...
      <div class="card p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4">
          <div class="flex-1 relative">
            ...
            <input v-model="quizSearch" type="text" placeholder="Tìm kiếm bài thi..." class="input-field pl-10"
    ...
    <div v-if="activeTab === 'questions'">
      ...
      <div class="card p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4">
          <div class="flex-1 relative">
            <MagnifyingGlassIcon class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
            <input v-model="questionSearch" type="text" placeholder="Tìm kiếm câu hỏi..." class="input-field pl-10"
      ...
      <div class="space-y-4">
        ...
        <div v-for="question in questions" :key="question.maCauHoi" class="card p-4 hover:shadow-md transition-shadow">
          <div class="flex items-start gap-4">
            <div class="flex-1">
              <p class="font-medium text-gray-900 mb-2">{{ question.noiDungCauHoi }}</p>
              <div class="flex flex-wrap gap-2 mb-2">
                <span v-for="option in question.cacLuaChon" :key="option.maLuaChon" :class="[
